...
type Header struct {
	...
	Description int32      `protobuf:"varint,2,opt,name=Description,proto3" json:"Description,omitempty"`
}
...
func (x *Header) GetDescription() int32 {
	if x != nil {
...
var file_common_common_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0b, 0x44, 0x65, 0x73, 0x63, 0x72, 0x69,
